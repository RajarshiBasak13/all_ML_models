...
Feature_model = PCA(n_components=2)
X_train = Feature_model.fit_transform(X_train)
X_test = Feature_model.transform(X_test)
print(Feature_model.explained_variance_ratio_)
